    ...
    const categoryHomepage = (movieList: any) => {
        ...
        return (
            <div>
                ...
                <div>
                    <div onClick={() => openCategory('action')} className="click category-header">
                ...
                <div>
                    <div onClick={() => openCategory('romance')} className="click category-header">
                ...
                <div>
                    <div onClick={() => openCategory('comedy')} className="click category-header">
                ...
                <div>
                    <div onClick={() => openCategory('children')} className="click category-header">
